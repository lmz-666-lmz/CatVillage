<template>
  <div class="min-h-[100dvh] bg-[#f5f7fb] px-5 pt-4 pb-8">
    ...
    <header class="sticky top-0 z-20 -mx-5 flex items-center justify-between bg-[#f5f7fb]/95 px-5 py-3 backdrop-blur">
      ...
      <h1 class="text-2xl font-black text-[#172033] tracking-tight">添加猫咪档案</h1>
      <button type="button" class="grid h-10 w-10 place-items-center text-[#748094]">
    ...
    <section class="mt-6 text-center">
      ...
      <p class="mt-4 text-[17px] text-[#748094]">点击上传猫咪头像</p>
    </section>
...
import { parseCatAgeToMonths } from '@/utils/age';
